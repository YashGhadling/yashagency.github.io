...
<div class="col-md-12">
<div class="row">
<h1 class="text-warning text-center my-3">HotelProduct</h1>
<?php
include "connection.php";
$record = mysqli_query($con,"select * from product_list where pcatogery='Hotel'");
