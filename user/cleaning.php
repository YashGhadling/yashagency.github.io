...
<meta charset="utf-8">
	...
	<title>CleaningProduct Page</title>
...
<div class="col-md-12">
<div class="row">
<h1 class="text-warning text-center my-3">CleaningProduct</h1>
<?php
include "connection.php";
$record = mysqli_query($con,"select * from product_list where pcatogery='CleaningProduct'");
...
<div class='card m-auto card border-0' style='width: 14rem;'>
